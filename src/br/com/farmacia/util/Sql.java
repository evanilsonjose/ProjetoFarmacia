...
public class Sql {
    ...
    public static final String ALTERAR_FORNECEDOR = "UPDATE fornecedor SET nome_fornecedor = ?, cnpj_fornecedor = ?, endereco_fornecedor = ?, telefone_fornecedor = ? WHERE cod_fornecedor = ?";
    ...
    public static final String ALTERAR_MEDICAMENTO = "UPDATE medicamento SET nome_medicamento = ?, preco_custo_medicamento = ?, preco_venda_medicamento = ?, qtd_estoque_medicamento = ?, cod_fornecedor = ?, generico_medicamento = ?, prescricao_medicamento = ?, categoria_medicamento = ? WHERE cod_medicamento = ?";
    ...
    public static final String ALTERAR_EQUIPAMENTO = "UPDATE equipamento SET nome_equipamento = ?, preco_venda_equipamento = ?, preco_custo_equipamento = ?, qtd_estoque_equipamento = ?, cod_fornecedor = ?, modo_operacao_equipamento = ? WHERE cod_equipamento = ?";
